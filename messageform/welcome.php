        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav ">
                ...
                <li class="nav-item my-2 ">
                    <a class="nav-link" href="../logout.php?Logout= ">Log out<i class="fas fa-sign-out-alt ml-2"></i> </a>
                </li>
                                ...
                                <div class="card ">
                                    <div class="card-header" id="heading<?= $row['id'] ?>">
                                        <h2 class="mb-0">
                                            ...
                                            <a href="../delete.php?dr=<?= $row['id'] ?>"
                                               class="btn btn-danger float-md-right">delete</a>
                                        </h2>
                                    </div>
